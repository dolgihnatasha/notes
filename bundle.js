...
/***/ function(module, exports, __webpack_require__) {
	...
	var LS = __webpack_require__(1).LocalStorage;
	...
	var NotesTable = _require.NotesTable;

	var search = __webpack_require__(168);

	var storage = LS.getLocalStorage();

	var allNotes = [{ name: 'vasiliy', email: 'qwerqwr', tel: '0' }, { name: 'vasiliy2', email: 'qwerqwr2', tel: '3456789' }, { name: 'vasiliy3', email: 'qwerqwr3', tel: '1234' }]; // храним здесь записи для для удобства
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heading = function Heading(name) {
