...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderNotes = __webpack_require__(1).renderNotes;
	var search = __webpack_require__(33);
	var sort = __webpack_require__(34).sort;
	var storage = __webpack_require__(35).LocalStorage.getLocalStorage();
	...
	function updateSortingClasses(field) {
	    ...
	    try {
	        for (var _iterator = currentSort.parentNode.childNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableRow = function TableRow(note) {
	    // одна запись
	    note = note.note;
	...
	var Heading = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'th',
	            { className: className, 'class': 'header', onclick: 'console.log(\'haha\');' },
	            React.createElement('span', { className: 'glyphicon glyphicon-sort-by-alphabet down' }),
	            React.createElement('span', { className: 'glyphicon glyphicon-sort-by-alphabet-alt up' }),
	            React.createElement('span', { className: 'glyphicon glyphicon-sort sort' }),
	            heading
	        );
	    }
	});
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'tr',
	                null,
	                React.createElement(Heading, { name: 'Name' }),
	                React.createElement(Heading, { name: 'e-mail' }),
	                React.createElement(Heading, { name: 'Tel' })
	            )
	        );
	    }
	});

	var TableBody = function TableBody(notes) {
	    //содержимое таблицы
	    var tableRows = notes.notes.map(function (note, i) {
	        return React.createElement(TableRow, { key: i, note: note });
	    });
	    return React.createElement(
	        'tbody',
	        { id: 'tbody' },
	...
	var NotesTable = function NotesTable(notes) {
	    // вся таблица
	    return React.createElement(
	        'table',
	        { id: 'myTable', className: 'table table-hover table-bordered table-striped' },
	        React.createElement(TableHeading, null),
	        React.createElement(TableBody, { notes: notes.notes })
	    );
	};

	function renderNotes(notes) {
	    ReactDOM.render(React.createElement(NotesTable, { notes: notes }), document.getElementById('table-container'));
	}
...
/***/ function(module, exports) {
	...
	var sorted = { name: null, asc: -1 };

	var sort = function sort(arr, name) {
	    var asc = name == sorted.name ? sorted.asc * -1 : 1;
	    sorted = { name: name, asc: asc };
	...
	var LocalStorage = function () {
	    ...
	    _createClass(LocalStorage, [{
	        ...
	        value: function onChange(func) {
	            // обработчик добавления записи из другой вкладки
	            window.addEventListener('storage', func);
	        }
	    }, {
	        key: 'onChangeHere',
	        value: function onChangeHere(func) {
	            // обработчик добавления записи в текущей вкладке
	            this.onAdd = func;
	        }
	    }, {
	        key: 'addNote',
